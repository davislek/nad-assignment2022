            ...
            <div class="container">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tr class="rem1">
                                ...
                                <div class="quantity">
                                    <div class="quantity-select">
                                        <form action="UpdateProductQuantity" method="post">
                                            <input type="hidden" value="<%=totalProduct.getInt(6)%>"
                            ...
                            <td class="invert"><%=totalProduct.getString(5)%>&nbsp;UGX.</td>
                            <td class="invert"><%=totalProduct.getString(6)%>&nbsp;UGX.</td>
                            <td class="invert"><a
                                    href="removeProductFromCart.jsp?productId=<%=totalProduct.getInt(6)%>"
                ...
                <form action="GetProductOrders" method="post">
                    ...
                    <div>
                        ...
                        <div>
                            <%
                                ResultSet rsPaymentId = DatabaseConnection.getResultFromSqlQuery("select max(payment_id) as current from tblorders");
                                if (rsPaymentId.next()) {
                                     paymentId = rsPaymentId.getInt("current");
                                    paymentId++;
                                }
                            %>
