                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                <form role="form" action="AddProducts" method="post"
                                    ...
                                    <div class="form-group">
                                        <label>Price</label> <input class="form-control" type="number" name="pPrice" required/>
                                    </div>
                                    <div class="form-group">
                                        <label>Description</label> <input class="form-control" type="text" style="min-height: 100px;" name="desc" required/>
                                    </div>
                                    <div class="form-group">
