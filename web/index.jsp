...
<body>
    ...
    <div class="product-easy">
        <div class="container">
            <div class="container">
                <h2>
                    <span><center style="color: orange"> GROUP 25 COURSEWORK:</center></span>
                </h2>
            </div>
            <%
                        ...
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                <input type="hidden" name="productId"
                                       ...
                                       src="uploads/<%=retriveProduct.getString("name")%>"
                            ...
                            <div class="item-info-product ">
                                ...
                                <div class="info-product-price">
                                    <input type="hidden" name="price"
                                           ...
                                           class="item_price"><%=retriveProduct.getString("price")%> UGX.</span>
                                ...
                                <input type="submit" value="Add to likes" class="btn btn-warning" onclick="return confirm('Are you sure Do you want to add this item in cart?');">
                            </div>
                        </div>
                    </div>
                </div>
