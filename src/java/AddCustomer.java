        ...
        try {
            ...
            if (addCustomer > 0) {
                ...
                //inserting into the total sales table for short_term
                 DatabaseConnection.insertUpdateFromSqlQuery("update set total_staff='"+total_male+"' where total_male='male' ");
                ...
                //inserting into the total sales table for long_term
                 DatabaseConnection.insertUpdateFromSqlQuery("update set total_staff='"+total_female+"' where total_female='female' ");
